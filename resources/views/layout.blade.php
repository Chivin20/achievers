    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent2">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('aboutus')}}" routerLink="/aboutus" routerLinkActive="active">About Us</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="{{route('ourstructure')}}" routerLink="/ourstructure" routerLinkActive="active">Our Structure</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="{{route('ourteam')}}" routerLink="/ourteam" routerLinkActive="active">Our Team</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="{{route('contactus')}}" routerLink="/Contactus" routerLinkActive="active">Contact Us</a>
          </li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mt-md-0 mt-3">
          ...
          <div class="wrapingimage">   
            <img src="{{url('/assets/img/logo2.jpg')}}" height="80px" width="80px" alt="logo" style = "padding-right:10px;">    
            </div>   
